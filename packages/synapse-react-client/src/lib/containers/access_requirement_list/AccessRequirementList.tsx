...
import { DialogSubsectionHeader } from './DataAccessRequestStyledComponents'
...
/**
 * Renders an access requirement in the list format
 */
function AccessRequirementListItem(props: {
  accessRequirement: AccessRequirement
  accessRequirementStatus: AccessRequirementStatus
  user?: UserProfile
  entityId: string
    ...
    <>
      ...
      <DialogContent>
        <div>
          ...
          {anyARsRequireTwoFactorAuth && <AuthenticatedRequirement />}
