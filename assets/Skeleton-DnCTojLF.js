import{r as v}from"./index-bqo5TgK4.js";import{a as C,g as b,c as k,e as w}from"./createTheme-DafKpa7R.js";import{u as x,s as R,c as S,m as $}from"./DefaultPropsProvider-D5B1AITN.js";import{j as U}from"./jsx-runtime-D_zvdyIk.js";import{a as u,k as c}from"./createSimplePaletteValueFilter-sGs_ku48.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return S({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
