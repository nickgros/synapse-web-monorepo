import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{sn as i,t as a,wn as o}from"./dist-C7SMz8Oe.js";import{n as s,o as c}from"./getEndpoint-urxz1wpW.js";import{Fn as l,xt as u}from"./synapse-client-CGkyy5Gl.js";import{i as d}from"./mock_user_profile-DpGVXyMi.js";import{n as f,r as p}from"./mockFileEntity-CIUoL-HH.js";import{a as m,c as h,h as g,i as _,l as v,m as y,u as b}from"./mockAccessRequirements-BZA8oeGM.js";import{E as x,Ft as S,G as C,It as w,K as T,Mt as E,Nt as D,Pt as O,T as k,a as A,f as j,jt as M,o as N,u as P}from"./iframe-De_0ycCw.js";import{i as F,t as I}from"./AccessRequirementList-DWos7YEw.js";function L(e){return[n.get(`${s}/auth/v1/2fa`,()=>{let n={status:e?`ENABLED`:`DISABLED`};return t.json(n,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{_(),S(),f(),O(),T(),x(),j(),N(),d(),l(),c(),a(),r(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:p.id,renderAsModal:!0},parameters:{msw:{handlers:[...C(s),...L(!1),...E(s),...M(s,void 0,[])]}}},B={parameters:{msw:{handlers:[...C(s),P(s,!0,!0),...L(!0),...E(s),...M(s),...D(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:i.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...A(s)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},V=[...h,{...b,id:21},{...g,id:22},{...y,id:23},{...m,id:24}],H={parameters:{msw:{handlers:[...C(s),P(s,!0,!0),...L(!0),...E(s),...M(s,void 0,V),...D(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:i.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(s),...k(s),n.post(`${s}${u}`,()=>{let e={requirementId:m.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...C(s),P(s,!0,!1),...L(!0),...E(s),...M(s),...D(s,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(s),n.post(`${s}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...C(s),P(s,!1,!0),...L(!0),...E(s),...M(s),...D(s,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(s),n.post(`${s}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...C(s),P(s,!0,!0),...L(!0),...E(s),...M(s,void 0,[b]),...D(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:i.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
 * You did not meet the requirements.
 * Another reason: you did not meet the requirements.
Feel free to apply again.`}}]),...A(s),...k(s)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},K={args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0},parameters:{msw:{handlers:[...C(s),P(s,!0,!0),...L(!0),...E(s),...M(s,void 0,[v]),...D(s,[{accessRequirementId:v.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(s)]}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
