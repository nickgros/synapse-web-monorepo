import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{n as i,o as a}from"./getEndpoint-urxz1wpW.js";import{Bt as o,Fn as s,Lt as c}from"./synapse-client-CGkyy5Gl.js";import{i as l,u}from"./mockAccessRequirements-BZA8oeGM.js";import{Ct as d,Mt as f,Pt as p,St as m,a as h,d as g,f as _,o as v,wt as y,xt as b}from"./iframe-De_0ycCw.js";import{n as x,t as S}from"./EDucPreviewStep-Bvx3_4hy.js";var C,w,T,E,D,O,k;e((()=>{l(),y(),p(),m(),_(),v(),s(),a(),r(),x(),C={...u,eDucTemplateId:`template-abc-123`},w=n.get(`${i}${c(d.id)}`,()=>t.json({fileHandleId:`mock-preview-file-handle-123`},{status:200})),T={title:`Governance/Data Access Request Flow/Managed Access Requirement/Step 2c - eDUC Preview`,component:S,parameters:{stack:`mock`,chromatic:{viewports:[600,1200]},msw:{handlers:[w,...g(i),...h(i),...f(i),...b(i)]}}},E={name:`eDUC preview step`,args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},D={name:`eDUC preview — error state`,parameters:{msw:{handlers:[n.get(`${i}${c(d.id)}`,()=>t.json({reason:`Preview could not be generated at this time.`},{status:500})),...g(i),...h(i),...f(i),...b(i)]}},args:{managedACTAccessRequirement:C}},O={name:`eDUC preview — user at signature quota`,parameters:{msw:{handlers:[w,n.get(`${i}${o(d.id)}`,()=>t.json({quota:3,remaining:0},{status:200})),...g(i),...h(i),...f(i),...b(i)]}},args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
