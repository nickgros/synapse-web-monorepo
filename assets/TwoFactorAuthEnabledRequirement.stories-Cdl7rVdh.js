import{s as o,b as n,H as c}from"./iframe-MKfqFOD8.js";import{T as m}from"./TwoFactorAuthEnabledRequirement-leDEyRaU.js";import"./index-Chi_LkuB.js";import"./RequirementItem-Z8EMa3WV.js";import"./LockTwoTone-_jJvTXdl.js";const w={title:"Governance/Data Access Request Flow/Requirements/TwoFactorAuthEnabledRequirement",component:m,parameters:{stack:"mock"},argTypes:{isAuthenticated:{control:{type:"boolean"}}},args:{isAuthenticated:!0}};function a(r){return[o.get(`${n}/auth/v1/2fa`,()=>{const s={status:r?"ENABLED":"DISABLED"};return c.json(s,{status:200})})]}const e={parameters:{msw:{handlers:[a(!0)]}}},t={parameters:{msw:{handlers:[a(!1)]}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
