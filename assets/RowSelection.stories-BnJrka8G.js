import{o as e}from"./preload-helper-CsHsquCd.js";import{t}from"./jsx-runtime-l3w3GfrB.js";import{kn as n,t as r}from"./esm-icottmGP.js";import{T as i,t as a}from"./lodash-5EZjp2uK.js";import{Bi as o,t as s}from"./esm-CbbVY1dr.js";import{i as c,r as l}from"./ToastMessage-Cb_KMe9p.js";import{n as u,t as d}from"./RowSelectionUI-cBTSxSd_.js";var f,p,m,h;e((()=>{c(),s(),u(),r(),a(),f=t(),p={title:`Explore/RowSelection`,argTypes:{numberOfActions:{type:`number`,description:`The number of actions to display`}},render:e=>{let{numberOfActions:t=0,...r}=e;return(0,f.jsx)(d,{...r,customControls:(0,f.jsx)(f.Fragment,{children:i(t,e=>(0,f.jsxs)(n,{variant:e===t-1?`contained`:`outlined`,color:e%3==3?`secondary`:`primary`,startIcon:(0,f.jsx)(o,{}),onClick:()=>l(`clicked action ${e}`),children:[`Action `,e]}))})})},parameters:{design:{type:`figma`,url:`https://www.figma.com/file/3l3RjDnKnv8jms2XFR5BQu/Main?type=design&node-id=462-39826`}}},m={name:`RowSelection`,args:{show:!0,selectedRowCount:5,onClearSelection:()=>{l(`clear selection called`)},numberOfActions:2}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  name: 'RowSelection',
  args: {
    show: true,
    selectedRowCount: 5,
