import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{n as i,o as a}from"./getEndpoint-urxz1wpW.js";import{Fn as o,Gt as s,Wt as c}from"./synapse-client-CGkyy5Gl.js";import{X as l,Z as u}from"./iframe-De_0ycCw.js";import{n as d,t as f}from"./EDucTemplateTable-CRZXWiDF.js";var p,m,h,g,_;e((()=>{u(),a(),o(),r(),d(),p={title:`Governance/eDUC Templates Table`,component:f,parameters:{stack:`mock`,msw:{handlers:l(i)}}},m={name:`Templates table`},h={name:`Templates table — invalid validation result`,parameters:{msw:{handlers:[n.get(`${i}${s(`:templateId`)}`,()=>t.json({isValid:!1,reason:`Template is missing required signer tab.`},{status:200})),...l(i)]}}},g={name:`Templates table — empty`,parameters:{msw:{handlers:[n.post(`${i}${c}`,()=>t.json({results:[]},{status:200}))]}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
